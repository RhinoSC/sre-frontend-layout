<template>
  <div
    class="relative w-[1920px] h-[1004px] flex flex-col justify-center bg-[url('/src/graphics/16_9_solo/assets/SRE-X_Layout_Background.png')] bg-cover bg-center">
    <!-- Pseudo-elemento before para la segunda imagen con el efecto -->
    <div
      class="w-[1920px] h-[1004px] absolute inset-0 before:content-[''] before:absolute before:inset-0 before:bg-[url('/src/graphics/16_9_solo/assets/SRE-X_Layout_SoftLight_Raya_tele.png')] before:bg-cover before:bg-center before:opacity-20">
    </div>
    <div
    ...
    <div class="relative z-10 w-[1920px] h-[1004px]">
      ...
      <div
        ...
        <div class="absolute bottom-[10px] left-[0px] w-[790px] h-[100px] flex flex-col items-center justify-center">
          <p class="mb-3 text-3xl font-bold text-[#FFCA6A] [text-shadow:_0_5px_4px_rgb(0_0_0_/_50%)] uppercase text-center pt-2"
            v-if="activeRunReplicant && activeRunReplicant.data">{{
              activeRunReplicant.data.name }}</p>
        </div>
        <div
          class="absolute top-[68px] left-[70px] w-[229px] h-[29px] bg-[url('/src/graphics/16_9_solo/assets/SRE-X_Layout_Icon_Platform_2.png')]">
        </div>
        ...
        <div
          class="absolute top-[68px] left-[495px] w-[229px] h-[29px] bg-[url('/src/graphics/16_9_solo/assets/SRE-X_Layout_Icon_Platform_1.png')]">
      ...
      <div v-if="timerReplicant && timerReplicant.data" :class="[
        ...
        <!-- div-time -->
        <div class="relative top-[10px] left-[0px] w-[721px] h-[47px] flex flex-col items-center justify-center">
          <p class="mb-3 text-5xl font-bold text-white [text-shadow:_0_5px_4px_rgb(0_0_0_/_50%)] uppercase text-center pt-2"
            :class="[
              timerReplicant.data.state === 'finished' ? 'text-teal-500 animate-finished' : 'animate-start',
