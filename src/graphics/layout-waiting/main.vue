<template>
  <div
    ...
    <div
      class="z-20 w-[1920px] h-[905px] top-[100px] absolute inset-0 after:content-[''] after:absolute after:inset-0 after:bg-[url('/src/graphics/layout-waiting/assets/SRE-X_Layout_2.Espera_Frame_1.png')] after:bg-cover after:bg-center">
    </div>
