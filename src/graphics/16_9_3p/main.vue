<template>
  <div
    ...
    <div
      class="z-20 w-[1920px] h-[1004px] absolute inset-0 after:content-[''] after:absolute after:inset-0 after:bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_4.Juego3_16-9_Frame_16_9_3p_1.png')] after:bg-cover after:bg-center">
    </div>
    ...
    <div class="relative z-10 w-[1920px] h-[1004px]">
      ...
      <div>
        <!-- div-game -->
        <div
          class="absolute left-[0px] w-[806px] h-[441px] bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_3.Juego_NormalBackground16_9_3p_2.png')]">
        </div>
        <!-- div-coms -->
        <div v-if="activeRunReplicant && activeRunReplicant.data && timerReplicant?.data"
          class="absolute top-[438px] left-[0px] w-[405px] h-[143px] overflow-hidden">
          <!-- div-runner -->
          <div
            class="z-20 absolute top-[0px] left-[65px] w-[341px] h-[55px] bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_4.Juego4_16-9_RunnerSUPERIO_16_9_3p_1.png')]">
          ...
          <!-- 1ro -->
          <div
            class="team team-1-1ro absolute -top-[84px] left-[117px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/1ro_16_9_3p.png')] bg-contain">
            <div class="h-full" v-if="first === activeRunReplicant.data.teams[0].id">
              <div class="flex flex-row items-center h-full gap-2 pt-1 text-white">
          ...
          <!-- 2ro -->
          <div
            class="team team-1-2ro absolute -top-[84px] left-[117px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/2ro_16_9_3p.png')] bg-contain">
          ...
          <!-- 3ro -->
          <div
            class="team team-1-3ro absolute -top-[84px] left-[117px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/3ro_16_9_3p.png')] bg-contain">
      ...
      <div>
        ...
        <div
          ...
          class="absolute top-[412px] left-[800px] w-[341px] h-[133px] overflow-hidden">
          <!-- div-runner -->
          <div
            class="z-20 absolute top-[77px] left-[0px] w-[341px] h-[56px] bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_4.Juego4_16-9_RunnerBAJO_16_9_3p_2.png')]">
            <div class="flex flex-col items-center justify-center w-full h-full">
          ...
          <!-- 1ro -->
          <div
            class="team team-2-1ro absolute top-[164px] left-[53px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/1ro_abajo_16_9_3p.png')] bg-contain">
          ...
          <!-- 2ro -->
          <div
            class="team team-2-2ro absolute top-[164px] left-[53px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/2ro_abajo_16_9_3p.png')] bg-contain">
          ...
          <!-- 3ro -->
          <div
            class="team team-2-3ro absolute top-[164px] left-[53px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/3ro_abajo_16_9_3p.png')] bg-contain">
          ...
          <!-- 4ro -->
          <div
            class="team team-2-4ro absolute top-[134px] left-[56px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/4ro_abajo_16_9_3p.png')] bg-contain">
      ...
      <div>
        <!-- div-info -->
        <div
          class="absolute top-[650px] left-[0px] w-[490px] h-[97px] bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_3.Juego_Game_16_9_3p_1.png')]">
          <!-- div-run -->
          <div
            class="absolute left-[10px] pt-[10px] w-[490px] h-[73px] pl-[8px] pr-[20px] flex flex-col items-center justify-center">
          ...
          <div
            class="absolute top-[60px] left-[30px] w-[150px] h-[24px] bg-[url('/src/graphics/_misc/assets/SRE-X_Layout_Icon_Platform_2.png')] bg-cover">
          </div>
          <div class="absolute top-[58px] left-[132px] w-[229px] h-[29px] flex flex-col items-center justify-center">
          ...
          <div
            class="absolute top-[60px] left-[305px] w-[150px] h-[24px] bg-[url('/src/graphics/_misc/assets/SRE-X_Layout_Icon_Platform_2.png')] bg-cover rotate-180">

          </div>
        </div>
        <!-- div-timer -->
        <div v-if="timerReplicant && timerReplicant.data" :class="[
          'absolute top-[750px] left-[0px] w-[490px] pt-[8px] h-[124px] bg-[url(/src/graphics/16_9_3p/assets/SRE-X_Layout_3.Juego_Timer_16_9_3p_1.png)]',
          ...
          <div v-if="timerReplicant && timerReplicant.data.state === 'finished'"
            class="absolute top-0 left-0 w-[490px] h-[210px] flash-div"></div>

          <!-- div-time -->
          <div
            class="relative top-[10px] left-[0px] w-[490px] h-[47px] flex flex-col items-center justify-center text-white">
          ...
          <!-- div-run-info -->
          <div
            class="relative top-[0px] left-[0px] pt-[30px] w-[490px] h-[47px] flex flex-row items-center justify-between gap-2">
            <!-- div-category -->
            <div class="flex flex-row items-center justify-start w-2/3 h-[96px] pl-[30px] gap-2">
            ...
            <!-- div-estimate -->
            <div class="flex flex-row items-center justify-center w-1/3 gap-2 pr-[10px]">
        ...
        <!-- div-coms-gen -->
        <div
          class="absolute top-[870px] left-[0px] w-[479px] h-[121px] bg-[url(/src/graphics/16_9_3p/assets/SRE-X_Layout_3.Juego_NormalBackground_16_9_3p_3.png)]">
        </div>
        <!-- div-logos -->
        <div
          class="absolute top-[670px] left-[1539px] w-[295px] h-[227px] bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_4.Juego3_16-9_Logo_16_9_3p_1.png')]">
          <div class="w-[295px] h-[227px] flex flex-row items-center justify-center">
        ...
        <!-- div-host -->
        <div
          class="absolute top-[886px] left-[1539px] w-[295px] h-[73px] bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_4.Juego3_16-9_Host_16_9_3p_1.png')]">
          <div class="flex flex-col items-center justify-center w-full h-full">
      ...
      <div>
        ...
        <div
          ...
          class="absolute top-[438px] left-[1515px] w-[341px] h-[143px] overflow-hidden">
          <!-- div-runner -->
          <div
            class="z-20 absolute top-[0px] left-[0px] w-[341px] h-[55px] bg-[url('/src/graphics/16_9_3p/assets/SRE-X_Layout_4.Juego4_16-9_RunnerSUPERIO_16_9_3p_1.png')]">
            <div class="flex flex-col items-center justify-center w-full h-full">
              <p class="username absolute text-2xl mb-3 font-bold text-white [text-shadow:_0_1px_0_rgb(0_0_0_/_40%)]">{{
          ...
          <!-- 1ro -->
          <div
            class="team team-3-1ro absolute -top-[84px] left-[52px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/1ro_16_9_3p.png')] bg-contain">
          ...
          <!-- 2ro -->
          <div
            class="team team-3-2ro absolute -top-[84px] left-[52px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/2ro_16_9_3p.png')] bg-contain">
          ...
          <!-- 3ro -->
          <div
            class="team team-3-3ro absolute -top-[84px] left-[52px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/3ro_16_9_3p.png')] bg-contain">
          ...
          <!-- 4ro -->
          <div
            class="team team-3-4ro absolute -top-[84px] left-[52px] w-[218px] h-[53px] bg-[url('/src/graphics/16_9_3p/assets/4ro_16_9_3p.png')] bg-contain">
  ...
  NodeCG.waitForReplicants(timerReplicant1.value, activeRunReplicant1.value).then(() => {
    ...
    timerReplicant1.value?.on('change', async (newValue, oldValue) => {
      if (newValue && newValue.teamFinishTimes && activeRunReplicant1.value && activeRunReplicant1.value.value) {
        ...
        // Verificar si el equipo 3 terminó
        if (newValue.teamFinishTimes[team3Id]) {
          // Solo proceder si team3Id aún no está en `first`, `second`, `third`, o `fourth`
        ...
        // Verificar si el equipo 4 terminó
        if (newValue.teamFinishTimes[team4Id]) {
          // Solo proceder si team4Id aún no está en `first`, `second`, `third`, o `fourth`
